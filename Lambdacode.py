...
def process_buckets():
    ...
    if bucket_list == 0:
        ...
        return_status = "Finished procesing all buckets"
...
# Dont add this area on the lambda code area because this area is for local use only.
